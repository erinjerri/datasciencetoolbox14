...
ListStore = {
  ...
  loadItems: function() {
    var loadRequest = $.ajax({
      type: 'GET',
      url: "https://listalous.herokuapp.com/lists/erinslist"
    })
  ...
  addItem: function(itemDescription) {
    ...
    type: 'POST',
    url: "http://listalous.herokuapp.com/lists/erinslist/items",
  ...
  toggleCompleteness: function(itemId) {
    ...
    type: 'PUT',
    url: "https://listalous.herokuapp.com/lists/erinslist/items/" + itemId,
